...
public class MobileServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println(docType +
                ...
                {
                    if(product.type.equals("SmartPhones"))
                    {   
                        out.println("<tr>");
                        out.println("<td>"); 
                        ...
                        out.println("</td>");
                        out.println("<td>");
                        out.println("<input type='image' name='submit' border='0' src='https://www.paypalobjects.com/webstatic/en_US/i/btn/png/btn_addtocart_120x26.png' alt='Add to Cart'>");
                        out.println("</br>");
                        out.println("</br>");
                        out.println("</form>");
                        out.println("</td>");
